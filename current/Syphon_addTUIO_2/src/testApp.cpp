...
void testApp::initScenes() {	//adds all the media at once //WIP why is text.png not opaque?
	...
	theScenes[2] = new Scene(640,480,"mov/DUMBO.mov","textextext-o.png",NUMOFSCENES,3);
	theScenes[3] = new Scene(640,480,"mov/timessqColor.mov","textextext-o.png",NUMOFSCENES,4);
